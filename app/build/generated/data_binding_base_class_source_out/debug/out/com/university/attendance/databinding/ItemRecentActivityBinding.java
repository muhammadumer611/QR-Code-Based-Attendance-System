...
public final class ItemRecentActivityBinding implements ViewBinding {
  ...
  private ItemRecentActivityBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivIcon,
  ...
  public static ItemRecentActivityBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemRecentActivityBinding((LinearLayout) rootView, ivIcon, tvDescription,
          tvTimeAgo, tvTitle);
    }
