...
public final class ActivityNotificationsBinding implements ViewBinding {
  ...
  private ActivityNotificationsBinding(@NonNull ConstraintLayout rootView,
      ...
      @NonNull RecyclerView recyclerNotifications, @NonNull TextView tvEmptyState) {
  ...
  public static ActivityNotificationsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityNotificationsBinding((ConstraintLayout) rootView, btnBackHeader,
          headerContainer, recyclerNotifications, tvEmptyState);
    }
