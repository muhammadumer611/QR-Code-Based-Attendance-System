...
public final class ItemNotificationBinding implements ViewBinding {
  ...
  private ItemNotificationBinding(@NonNull LinearLayout rootView, @NonNull ImageView ivIcon,
      @NonNull TextView tvDescription, @NonNull TextView tvTimeAgo, @NonNull TextView tvTitle,
  ...
  public static ItemNotificationBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemNotificationBinding((LinearLayout) rootView, ivIcon, tvDescription, tvTimeAgo,
          tvTitle, unreadDot);
    }
