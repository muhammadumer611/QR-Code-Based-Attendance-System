...
class ActivityAdminDashboard : AppCompatActivity() {
    ...
    private val cardSearchTargets by lazy {
        listOf(
            ...
            CardSearchTarget(listOf("student class", "class allocation", "student allocation", "assign class", "student class assignment"), binding.cardStudentClassAssignment),
            CardSearchTarget(
                listOf(
                    "student subjects",
                    "student subject",
            ...
            CardSearchTarget(listOf("class management", "create class", "class section", "manage classes"), binding.cardClassManagement),
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.cardStudentClassAssignment.setOnClickListener {
            startActivity(Intent(this, ActivityStudentClassAssignment::class.java))
        }
        ...
        binding.cardClassManagement.setOnClickListener {
            startActivity(Intent(this, ActivityClassManagement::class.java))
        }
