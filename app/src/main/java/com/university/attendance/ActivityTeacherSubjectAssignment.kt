...
class ActivityTeacherSubjectAssignment :
    ...
    private fun setupInputs() {
        ...
        binding.etAssignmentSemester.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus) binding.etAssignmentSemester.showDropDown()
        }
        ...
        binding.etAssignmentClass
            .setOnFocusChangeListener { _, hasFocus ->
                if (hasFocus && binding.etAssignmentClass.isEnabled) {
