        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                if (
                    ...
                    showMessage(
                        "No active students with a class assigned."
                    )
                }
    ...
    private fun loadStudent(
        ...
        lifecycleScope.launch {
            ...
            try {
                ...
                /*
                 * Subjects now come directly from
                 * Subject Management.
                 *
                 * Teacher assignment is NOT required.
                 */
                available =
                ...
                if (
                    ...
                    showMessage(
                        "No subjects found for ${student.programName}, Semester ${student.semester}. Check Subject Management."
                    )
