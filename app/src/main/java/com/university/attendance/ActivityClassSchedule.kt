...
class ActivityClassSchedule : AppCompatActivity() {
    ...
    private fun showAddClassDialog() {
        ...
        dialogBinding.etTeacher.setOnItemClickListener {
            ...
            // If Semester + Session were already entered, immediately
            // load the classes assigned to this teacher.
            loadSubjectsForScheduleDialog(dialogBinding)
        }
        ...
        // Explicitly open the class dropdown. Without this, the field
        // can receive the adapter but the user cannot open it by tapping.
        ...
        dialogBinding.etClass.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus && dialogBinding.etClass.isEnabled) {
                dialogBinding.etClass.showDropDown()
            }
        }

        // Explicitly open the subject dropdown as well.
        ...
        dialogBinding.etSubject.setOnFocusChangeListener { _, hasFocus ->
            if (hasFocus && dialogBinding.etSubject.isEnabled) {
                dialogBinding.etSubject.showDropDown()
            }
        }
    ...
    // ============================================================
    // LOAD ASSIGNED CLASS + SUBJECTS FOR TEACHER + SEMESTER + SESSION
    // ============================================================
