...
abstract class BaseAuthActivity : AppCompatActivity() {
    ...
    protected fun registerStudent(onSuccess: () -> Unit) {
        ...
        db.collection("students")
            ...
            .addOnSuccessListener { snapshot ->
                ...
                val recordEmail =
                    document.getString("personalEmail")
                        ?.trim()
                        ?.lowercase()
                        ?: ""
    ...
    protected fun validateStudentSignIn(): Boolean {
    ...
    protected fun signInStudent(
        onSuccess: () -> Unit
    ) {

        if (!validateStudentSignIn()) {
            return
        }
                ...
                db.collection("students")
                    ...
                    .addOnSuccessListener { snapshot ->
                        ...
                        if (snapshot.isEmpty) {
                            ...
                            Toast.makeText(
                                this,
                                "Student profile is not linked with this account.",
                                Toast.LENGTH_LONG
                            ).show()
