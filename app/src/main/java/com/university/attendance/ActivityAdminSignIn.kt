...
class ActivityAdminSignIn : BaseAuthActivity() {
    ...
    override fun getOppositeScreen() = ActivityAdminSignUp::class.java
    override fun getDashboardScreen() = ActivityAdminDashboard::class.java // TODO: AdminDashboard
}