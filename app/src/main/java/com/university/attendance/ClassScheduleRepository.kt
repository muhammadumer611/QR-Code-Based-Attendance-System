...
class ClassScheduleRepository(
    ...
    suspend fun saveClass(
        ...
        return try {
            ...
            val exactAssignmentDoc =
                assignmentRef
                    ...
                    .firstOrNull { doc ->
                        ...
                        doc.getString("classId") == classSchedule.classId &&
                                doc.getString("subjectId") == classSchedule.subjectId &&
                                numberField(doc.get("semester")) == classSchedule.semester &&
                                doc.getString("session").orEmpty().trim()
                                    .equals(classSchedule.session.trim(), true) &&
                                doc.getString("section").orEmpty().trim()
                                    .equals(classSchedule.section.trim(), true)
                    }

            val exactAssignment = exactAssignmentDoc != null
            ...
            // Always link the schedule to the immutable exact assignment.
            classSchedule.assignmentId = exactAssignmentDoc!!.id
