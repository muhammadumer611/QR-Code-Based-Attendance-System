            ...
            .mapNotNull { doc ->
                ...
                if (subjectId.isNullOrBlank()) {
                    ...
                    Subject(
                        ...
                        courseCode = doc.getString("courseCode").orEmpty(),
                        programName = doc.getString("programName").orEmpty(),
                        departmentName = doc.getString("departmentName").orEmpty(),
                        semester = doc.getLong("semester")?.toInt()?.toString() ?: "1",
                        teacherId = teacherId,
                        teacherName = doc.getString("teacherName").orEmpty(),
                        classId = doc.getString("classId").orEmpty(),
                        className = doc.getString("className").orEmpty(),
                        section = doc.getString("section").orEmpty(),
                        sessionName = doc.getString("session").orEmpty()
                    )
                }
            }
            .distinctBy {
