...
/**
 * Centralized validation rules for the Add Student form.
 * Keeping these in one place avoids duplicated/inconsistent checks
 * between Step 1 and Step 2 of the form.
 */
