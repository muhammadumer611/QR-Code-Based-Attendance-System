...
class ActivityTeacherDashboard : AppCompatActivity() {
        ...
        val openAttendance =
            View.OnClickListener {
                ...
                if (todayClass == null) {
                    ...
                    Toast.makeText(
                        this,
                        "No class is scheduled for attendance today.",
                        Toast.LENGTH_LONG
                    ).show()
    ...
    // ============================================================
    // TAKE ATTENDANCE (TODAY CARD CLICK)
    // ============================================================
    ...
    private fun openAttendance(
        ...
        val intent =
            Intent(
                ...
                putExtra(
                    "departmentName",
                    classSchedule.departmentName
                )

                putExtra(
                    "programName",
                    classSchedule.programName
                )
