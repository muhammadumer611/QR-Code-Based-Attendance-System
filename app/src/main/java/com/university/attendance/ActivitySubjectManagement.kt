...
class ActivitySubjectManagement : AppCompatActivity() {
    ...
    private val programOptions = listOf("BSSE", "BSCS", "BSIT", "BSAI", "BBA", "BSEE", "BS Math")
    ...
    private fun observeDepartments() {
        viewModel.departments.observe(this) { departments ->
            ...
            binding.etFilterDepartment.setOnFocusChangeListener { _, hasFocus ->
                if (hasFocus) binding.etFilterDepartment.showDropDown()
            }
