 ...
 * Handles all Firestore CRUD operations for the "subjects" collection.
 *
 * UPDATED: after a successful addSubject(), logs an ActivityLog +
    ...
    suspend fun addSubject(subject: Subject): OpResult {
        return try {
            ...
            ActivityLogHelper.log(
                type = Type.SUBJECT_ADDED,
                title = "Subject Added",
                description = "${subject.subjectName} (${subject.courseCode}) added to ${subject.departmentName}"
            )
